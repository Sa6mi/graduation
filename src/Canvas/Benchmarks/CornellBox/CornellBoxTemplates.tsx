...
export function ClassicCornellBox() {
  return (
    <CornellBox leftWallColor="#ff0000" rightWallColor="#00ff00" lightIntensity={pointLightClassicIntensity}>
      ...
      <mesh position={[1, -1.5, 0]} rotation={[0, Math.PI/4, 0]} castShadow={CastShadow} receiveShadow={ReceiveShadow}>
...
export function MetallicBox() {
  return (
    <CornellBox leftWallColor="#888888" rightWallColor="#444444" lightPosition={[1.8, 2, 0]} lightIntensity={pointLightMetallicIntensity}>
